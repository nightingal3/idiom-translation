...
def add_generation_args(parser):
    ...
    # from https://github.com/urvashik/knnmt/ repo
    # knnmt arguments
    ...
    # some of these weren't in the code but seem to be needed args
    group.add_argument('--knn-keytype', type=str, default='last_ffn_input')
    group.add_argument("--dstore_fp16", action='store_true', default=False)
    group.add_argument("--dstore-size", type=int, required=False)
