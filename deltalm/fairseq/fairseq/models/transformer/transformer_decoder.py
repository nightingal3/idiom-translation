...
class TransformerDecoderBase(FairseqIncrementalDecoder):
    ...
    def __init__(
        ...
        # knn args
        self.knn_keytype = cfg.knn_keytype_decoder
    ...
    def extract_features_scriptable(
        ...
        for idx, layer in enumerate(self.layers):
            ...
            x, layer_attn, _ = layer(
                ...
                enc, # (src_len, batch_size, embed_dim)
                padding_mask,
                incremental_state,
        ...
        # there aren't any other settings right?
        # TODO: explicitly constrain this and add explanation
