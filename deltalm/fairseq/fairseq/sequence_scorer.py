                ...
                [
                    {
                        ...
                        'dstore_keys': decoder_out[1][kwargs["knn_keytype"]][start_idxs[i]:,i,:] if "save_knnlm_dstore" in kwargs and kwargs["save_knnlm_dstore"] else None,
                        'dstore_keys_mt': decoder_out[1][kwargs["knn_keytype"]][start_idxs[i]:,i,:] if "save_knn_dstore" in kwargs and kwargs["save_knn_dstore"] else None,
                    }
                ]
            )
        return hypos
