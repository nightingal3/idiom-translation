...
import torch
# really bizarre issue. Installing fairseq from source here but metrics can't be found.
# the appropriate function(s) is actually in logging.metrics
...
class FairseqTask(object):
    ...
    def inference_step(
        self, generator, models, sample, prefix_tokens=None, constraints=None, other_args: dict = None
    ):
        with torch.no_grad():
            return generator.generate(
                models, sample, prefix_tokens=prefix_tokens, constraints=constraints, **other_args
            )
