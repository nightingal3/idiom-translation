...
parser.add_argument('--dimension', type=int, default=512, help='Size of each key')
...
parser.add_argument('--ncentroids', type=int, default=1, help='number of centroids faiss should learn')
...
parser.add_argument('--num_keys_to_add_at_a_time', default=3, type=int,
